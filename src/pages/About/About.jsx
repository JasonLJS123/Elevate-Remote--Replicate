        ...
        <React.Fragment>
          ...
          <div className={styles.aboutCanvas}>
            ...
            <div className={styles.ASection1}>
              ...
              <div className={styles.AS2ImageBox}>
