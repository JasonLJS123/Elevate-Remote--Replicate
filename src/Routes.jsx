...
const Jobs_DetailsPage = React.lazy(() =>
  import('./pages/JobApplication/JobApplication')
);
const LoginPage = React.lazy(() => import('./pages/Login/Login'));
const SignUpPage = React.lazy(() => import('./pages/SignUp/SignUp'));
const FindJobPage = React.lazy(() => import('./pages/JobFinding/JobFinding'));
const JobResultPage = React.lazy(() => import('./pages/JobResult/JobResult'));
